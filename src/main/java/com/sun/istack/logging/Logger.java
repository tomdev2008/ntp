...
public class Logger {
     ...
     * {@link #getSystemLoggerName(Class)} to generate default logger name.
     * </p>
     * <p>
     ...
     * package of the component class is needed. For all common use cases please use {@link #getLogger(Class)}
     * method.
     *
     ...
     * {@code exception}'s class provides constructor to initialize the original
     * cause. In such case you do not need to use
     * {@link #logException(Throwable, Throwable, java.util.logging.Level) logException(exception, cause, level)}
     * method version but you might still want to log the original cause as well.
     *
     * @param exception exception whose message should be logged. Must not be
     *        {@code null}.
    ...
    /**
     * Same as {@link #logException(Throwable, Throwable, java.util.logging.Level)
