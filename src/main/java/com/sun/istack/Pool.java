...
public interface Pool<T> {
    ...
    /**
     * Default implementation that uses {@link java.util.concurrent.ConcurrentLinkedQueue}
     * as the data store.
     *
     * <h2>Note for Implementors</h2>
     * <p>
     * Don't rely on the fact that this class extends from {@link java.util.concurrent.ConcurrentLinkedQueue}.
     */
