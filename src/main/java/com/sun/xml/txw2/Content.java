...
abstract class Content {
     ...
     *
     * @param doc
     *      A {@link com.sun.xml.txw2.Content} object is so light-weight that
     *      it doesn't even remember what document it belongs to.
     *      So the caller needs to "remind" a {@link com.sun.xml.txw2.Content}
     *      who its owner is.
     */
    ...
    /**
     * Returns true if this {@link com.sun.xml.txw2.Content} can guarantee that
