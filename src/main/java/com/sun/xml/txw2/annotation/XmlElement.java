 ...
 * from {@link com.sun.xml.txw2.TypedXmlWriter}, it specifies that the invocation
 ...
 *  <dd>TW must be an interface derived from {@link com.sun.xml.txw2.TypedXmlWriter}.
 ...
 * <p>
 * When used on interfaces that derive from {@link com.sun.xml.txw2.TypedXmlWriter},
 * it associates an element name with that interface. This name is
 * used in a few places, such as in {@link com.sun.xml.txw2.TXW#create(Class, com.sun.xml.txw2.output.XmlSerializer)}
 * and {@link com.sun.xml.txw2.TypedXmlWriter#_element(Class)}.
 *
 *
...
public @interface XmlElement {
     ...
     * then the namespace URI is taken from {@link com.sun.xml.txw2.annotation.XmlNamespace} annotation on
     * the package that the interface is in. If {@link com.sun.xml.txw2.annotation.XmlNamespace} annotation
