...
public abstract class TXW {
    ...
    /**
     * Creates a new {@link com.sun.xml.txw2.TypedXmlWriter} to write a new instance of a document.
     *
     * @param rootElement
     *      The {@link com.sun.xml.txw2.TypedXmlWriter} interface that declares the content model of the root element.
     *      This interface must have {@link com.sun.xml.txw2.annotation.XmlElement} annotation on it to designate the tag name
     *      of the root element.
     * @param out
     ...
     *
     * @see #create(Class, com.sun.xml.txw2.output.XmlSerializer)
     */
