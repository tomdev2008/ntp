...
public final class Document {
    ...
    /**
     * Set to true once we invoke {@link com.sun.xml.txw2.output.XmlSerializer#startDocument()}.
     *
     * <p>
     ...
     * so that we can fix up dummy prefixes in {@link com.sun.xml.txw2.Pcdata}.
     */
     ...
     *
     * <p>
     * Applications can add their own {@link com.sun.xml.txw2.DatatypeWriter} so that
     * application-specific objects can be turned into {@link String}
     * for output.
     *
     * @param dw
     *      The {@link com.sun.xml.txw2.DatatypeWriter} to be added. Must not be null.
     */
