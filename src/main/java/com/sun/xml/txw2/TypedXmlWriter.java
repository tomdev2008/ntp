...
public interface TypedXmlWriter {
    ...
    /**
     * Gets the {@link com.sun.xml.txw2.Document} object that this writer is writing to.
     *
     * @return
     *      always non-null.
     */
     ...
     *
     * @see #_attribute(javax.xml.namespace.QName, Object)
     */
     ...
     *      if the underlying {@link com.sun.xml.txw2.output.XmlSerializer} does not support
     ...
     *
     * @return
     *      always return non-null {@link com.sun.xml.txw2.TypedXmlWriter} that can be used
     ...
     * annotated with {@link com.sun.xml.txw2.annotation.XmlElement} annotation. The element name will be
     * taken from there.
     *
     * @see #_element(String, String, Class)
     */
