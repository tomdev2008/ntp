 ...
 * {@link com.sun.xml.txw2.output.XMLWriter} class cannot
 ...
 * </pre>
 *
 * <p>This class inherits from {@link com.sun.xml.txw2.output.XMLWriter},
 * and provides all of the same support for Namespaces.</p>
 *
 * @since 1.0
 * @author David Megginson, david@megginson.com
 * @version 0.2
 * @see com.sun.xml.txw2.output.XMLWriter
 */
...

     ...
     *
     * @see com.sun.xml.txw2.output.XMLWriter#reset()
     */
    public void reset ()
    {
        depth = 0;
     ...
     * @see com.sun.xml.txw2.output.XMLWriter#startElement(String, String, String, org.xml.sax.Attributes)
     */
     ...
     *            down the chain raises an exception.
     * @see com.sun.xml.txw2.output.XMLWriter#endElement(String, String, String)
     */
...
//    }
     ...
     *            down the chain raises an exception.
     * @see com.sun.xml.txw2.output.XMLWriter#characters(char[], int, int)
     */
