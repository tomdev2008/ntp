 ...
 *      {@link javax.xml.bind.annotation.XmlElement}
 *      int x;
 *      {@link com.sun.xml.bind.annotation.XmlIsSet}("x")
 *      boolean xIsPresent;
 * }
 *
 * Foo f = new Foo();
 ...
 *
 * <p>
 * A property/field annotated with {@link com.sun.xml.bind.annotation.XmlIsSet} itself will not show up in XML.
 * It is an error to use this annotation on the same property/field
 * as {@link javax.xml.bind.annotation.XmlElement}, {@link javax.xml.bind.annotation.XmlAttribute}, {@link javax.xml.bind.annotation.XmlValue}, or {@link javax.xml.bind.annotation.XmlElementRef},
 * ...<b>TBD</b>.
 *
 * @deprecated
