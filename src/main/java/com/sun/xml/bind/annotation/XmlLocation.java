 ...
 * <ul>
 *  <li>a field whose type is {@link org.xml.sax.Locator}, or
 *  <li>a method that takes a {@link org.xml.sax.Locator} as the sole parameter
 * </ul>
 *
 * <p>
 * When a class that contains such a field/method is unmarshalled by the JAXB RI,
 * such a field/method will receive an immutable {@link org.xml.sax.Locator} object that describes
