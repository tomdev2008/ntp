 ...
 * {@link javax.xml.bind.Unmarshaller#setProperty(String, Object)} to ovierride the ID/IDREF
 ...
 *
 * <p>
 * When the {@link #startDocument(javax.xml.bind.ValidationEventHandler)} method is invoked,
 * the unmarshaller passes in a {@link javax.xml.bind.ValidationEventHandler} that can be used
 ...
 * {@link javax.xml.bind.ValidationEventHandler}. If the error is fatal or the event handler
 * decided to abort, the implementation should throw a {@link org.xml.sax.SAXException}.
...
public abstract class IDResolver {
     ...
     *
     * <p>
     * Since one {@link javax.xml.bind.Unmarshaller} may be used multiple times
     * to unmarshal documents, one {@link com.sun.xml.bind.IDResolver} may be used multiple times, too.
     *
     * @param eventHandler
     ...
     *
     * <p>
     * This method returns a {@link java.util.concurrent.Callable} to support forward-references.
     * When this method returns with a non-null return value,
     * the JAXB RI unmarshaller invokes the {@link java.util.concurrent.Callable#call()} method immediately.
     ...
     *
     * <p>
     * A {@link java.util.concurrent.Callable} object returned from this method may not throw
     * any exception other than a {@link org.xml.sax.SAXException} (which means a fatal error.)
     *
     * @param id
     ...
     *      information from the signature of the fields that has {@link javax.xml.bind.annotation.XmlIDREF}.
