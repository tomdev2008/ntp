...
public abstract class Bridge<T> {
    ...
    /**
     * Gets the {@link com.sun.xml.bind.api.JAXBRIContext} to which this object belongs.
     *
     * @since 2.1
     */
     ...
     * associated with this instance of {@link com.sun.xml.bind.api.Bridge}.
     *
     * @param nsContext
     *      if this marshalling is done to marshal a subelement, this {@link javax.xml.namespace.NamespaceContext}
     ...
     *      that encloses the XML type that this {@link com.sun.xml.bind.api.Bridge} is
     *      instanciated for.
     *
     * @return
     *      never null.
    ...
    /**
     * Gets the {@link com.sun.xml.bind.api.TypeReference} from which this bridge was created.
     */
