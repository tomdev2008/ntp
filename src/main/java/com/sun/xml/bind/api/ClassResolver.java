 ...
 * <h2>Background</h2>
 * <p>
 * {@link javax.xml.bind.JAXBContext#newInstance(Class...)} requires that application informs JAXB
 ...
 *
 * <p>
 * This is where {@link com.sun.xml.bind.api.ClassResolver} comes to resucue.
 *
 * <p>
 * A {@link com.sun.xml.bind.api.ClassResolver} instance can be specified on {@link javax.xml.bind.Unmarshaller} via
 * {@link javax.xml.bind.Unmarshaller#setProperty(String, Object)} as follows:
 *
 * <pre>
 ...
 *
 * <p>
 * When an {@link javax.xml.bind.Unmarshaller} encounters (i) an unknown root element or (ii) unknown
 * elements where unmarshaller is trying to unmarshal into {@link javax.xml.bind.annotation.XmlAnyElement} with
 ...
 *
 * <p>
 * When a {@link Class} is returned, a new {@link javax.xml.bind.JAXBContext} is created with
 ...
 * {@link com.sun.xml.bind.api.ClassResolver#resolveElementName(String, String)}.
 *
...
public abstract class ClassResolver {
     ...
     *      the unmarshaller will behave as if there was no {@link com.sun.xml.bind.api.ClassResolver}
     *      to begin with (that is, to report it to {@link javax.xml.bind.ValidationEventHandler},
     *      then move on.)
     *
     * @throws Exception
     ...
     *      reproted to {@link javax.xml.bind.ValidationEventHandler} (just like any other error
