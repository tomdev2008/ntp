...
/**
 * {@link javax.xml.bind.JAXBContext} enhanced with JAXB RI specific functionalities.
 *
 * <p>
...
public abstract class JAXBRIContext extends JAXBContext {
    ...
    /**
     * Creates a new {@link com.sun.xml.bind.api.JAXBRIContext}.
     *
     * <p>
     * {@link javax.xml.bind.JAXBContext#newInstance(Class[]) JAXBContext.newInstance()} methods may
     ...
     *
     * @param classes
     *      Classes to be bound. See {@link javax.xml.bind.JAXBContext#newInstance(Class[])} for the meaning.
     * @param typeRefs
     ...
     * that has {@link javax.xml.bind.annotation.XmlAttachmentRef}.
     *
     * @since 2.1
     */
    ...
    /**
     * Creates a mini-marshaller/unmarshaller that can process a {@link com.sun.xml.bind.api.TypeReference}.
     *
     * @return
     *      null if the specified reference is not given to {@link com.sun.xml.bind.api.JAXBRIContext#newInstance}.
     *
     * @since 2.0 EA1
     */
    ...
    /**
     * Creates a new {@link com.sun.xml.bind.api.BridgeContext} instance.
     *
     * @return
    ...
    /**
     * Gets a {@link com.sun.xml.bind.api.RawAccessor} for the specified element property of the specified wrapper bean class.
     *
     * <p>
     ...
     * on the given wrapper bean, then returns a {@link com.sun.xml.bind.api.RawAccessor} that allows the caller
    ...
    /**
     * Gets the namespace URIs statically known to this {@link javax.xml.bind.JAXBContext}.
     *
     * <p>
     ...
     *      if {@link javax.xml.bind.SchemaOutputResolver} throws an {@link java.io.IOException}.
     */
    @Override
     ...
     *
     * @param tr
     *      must not be null. This must be one of the {@link com.sun.xml.bind.api.TypeReference}s specified
     *      in the {@link com.sun.xml.bind.api.JAXBRIContext#newInstance} method.
     *
     * @throws IllegalArgumentException
     *      if the parameter is null or not a part of the {@link com.sun.xml.bind.api.TypeReference}s specified
     *      in the {@link com.sun.xml.bind.api.JAXBRIContext#newInstance} method.
     *
     * @return null
    ...
    /**
     * Generates the episode file that represents the binding known to this {@link javax.xml.bind.JAXBContext},
    ...
    /**
     * The property that you can specify to {@link javax.xml.bind.JAXBContext#newInstance}
    ...
    /**
     * The property that you can specify to {@link javax.xml.bind.JAXBContext#newInstance}
     * to put additional JAXB type references into the {@link javax.xml.bind.JAXBContext}.
     *
     * <p>
     * The value of the property is {@link java.util.Collection}&lt;{@link com.sun.xml.bind.api.TypeReference}>.
     * Those {@link com.sun.xml.bind.api.TypeReference}s can then be used to create {@link com.sun.xml.bind.api.Bridge}s.
     *
     * <p>
     * This mechanism allows additional element declarations that were not a part of
     * the schema into the created {@link javax.xml.bind.JAXBContext}.
     *
     * @since 2.0 EA1
     */
    ...
    /**
     * The property that you can specify to {@link javax.xml.bind.JAXBContext#newInstance}
     * and {@link javax.xml.bind.Marshaller#setProperty(String, Object)}
     * to enable the c14n marshalling support in the {@link javax.xml.bind.JAXBContext}.
     *
    ...
    /**
     * The property that you can specify to {@link javax.xml.bind.JAXBContext#newInstance}
     * to use alternative {@link com.sun.xml.bind.v2.model.annotation.RuntimeAnnotationReader} implementation.
     *
     * @since 2.1 EA2
     */
    ...
    /**
     * The property that you can specify to {@link javax.xml.bind.JAXBContext#newInstance}
     * enable support of XmlAccessorFactory annotation in the {@link javax.xml.bind.JAXBContext}.
     *
     * @since 2.1 EA2
     */
