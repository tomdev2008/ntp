...
/**
 * A particular use (specialization) of {@link javax.xml.bind.JAXBElement}.
 *
...
public interface ElementInfo<T,C> extends Element<T,C> {
    ...
    /**
     * Returns the representation for {@link javax.xml.bind.JAXBElement}&lt;<i>contentInMemoryType</i>&gt;.
     *
     * <p>
     ...
     * @inheritDoc
     *
     * {@link com.sun.xml.bind.v2.model.core.ElementInfo} can only substitute {@link com.sun.xml.bind.v2.model.core.ElementInfo}.
     */
    ElementInfo<T,C> getSubstitutionHead();

    /**
     * All the {@link com.sun.xml.bind.v2.model.core.ElementInfo}s whose {@link #getSubstitutionHead()} points
     * to this object.
     *
     * @return
