...
/**
 * Builds a {@link com.sun.xml.bind.v2.model.core.TypeInfoSet} (a set of JAXB properties)
 * by using {@link com.sun.xml.bind.v2.model.impl.ElementInfoImpl} and {@link com.sun.xml.bind.v2.model.impl.ClassInfoImpl}.
 * from annotated Java classes.
 *
 * <p>
 * This class uses {@link com.sun.xml.bind.v2.model.nav.Navigator} and {@link com.sun.xml.bind.v2.model.annotation.AnnotationReader} to
...
public class ModelBuilder<T,C,F,M> {
    ...
    /**
     * {@link com.sun.xml.bind.v2.model.core.TypeInfo}s that are built will go into this set.
     */
    ...
    /**
     * Set to true if the model includes {@link javax.xml.bind.annotation.XmlAttachmentRef}. JAX-WS
    ...
    /**
     * Builds a JAXB {@link com.sun.xml.bind.v2.model.core.ClassInfo} model from a given class declaration
     * and adds that to this model owner.
     *
     * <p>
     * Return type is either {@link com.sun.xml.bind.v2.model.core.ClassInfo} or {@link com.sun.xml.bind.v2.model.core.LeafInfo} (for types like
     ...
     * and returns a {@link com.sun.xml.bind.v2.model.core.NonElement} that represents it.
     *
     * @return
     *      always non-null.
     */
    ...
    /**
     * Visits a class with {@link javax.xml.bind.annotation.XmlRegistry} and records all the element mappings
     * in it.
     */
    ...
    /**
     * Gets a {@link com.sun.xml.bind.v2.model.core.RegistryInfo} for the given package.
     *
     * @return
     ...
     *
     * @return
     *      fully built {@link com.sun.xml.bind.v2.model.core.TypeInfoSet} that represents the model,
