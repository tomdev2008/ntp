...
public interface PropertyInfo<T,C> extends AnnotationSource {
    ...
    /**
     * Gets the {@link com.sun.xml.bind.v2.model.core.ClassInfo} or {@link com.sun.xml.bind.v2.model.core.ElementInfo} to which this property belongs.
     */
    TypeInfo<T,C> parent();
     ...
     *
     * @see javax.xml.bind.annotation.XmlType#propOrder()
     */
    String getName();
    ...
    /**
     * List of {@link com.sun.xml.bind.v2.model.core.TypeInfo}s that this property references.
     *
     ...
     * @see javax.xml.bind.annotation.XmlIDREF
     *
     * @return
     *      always non-null
     */
    ...
    /**
     * The effective value of {@link javax.xml.bind.annotation.XmlSchemaType} annotation, if any.
     *
     * <p>
     * If the property doesn't have {@link javax.xml.bind.annotation.XmlSchemaType} annotation,
     ...
     * by using {@link com.sun.xml.bind.v2.model.core.NonElement#getTypeName()}. This method is to correctly
     * implement the ugly semantics of {@link javax.xml.bind.annotation.XmlSchemaType} (namely
