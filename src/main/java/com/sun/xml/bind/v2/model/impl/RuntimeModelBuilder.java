...
/**
 * {@link com.sun.xml.bind.v2.model.impl.ModelBuilder} that works at the run-time by using
 * the {@code java.lang.reflect} package.
 *
 * <p>
 * This extends {@link com.sun.xml.bind.v2.model.impl.ModelBuilder} by providing more functionalities such
...
public class RuntimeModelBuilder extends ModelBuilder<Type,Class,Field,Method> {
    /**
     * The {@link com.sun.xml.bind.v2.runtime.JAXBContextImpl} for which the model is built.
    ...
    /**
     * Creates a {@link com.sun.xml.bind.v2.runtime.Transducer} given a reference.
     *
     * Used to implement {@link com.sun.xml.bind.v2.model.runtime.RuntimeNonElementRef#getTransducer()}.
     ...
     *
     * This transducer wraps another {@link com.sun.xml.bind.v2.runtime.Transducer} and adds
     * handling for ID.
     */
