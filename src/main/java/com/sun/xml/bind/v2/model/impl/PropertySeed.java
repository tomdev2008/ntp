...
/**
 * Exposes the core information that forms a {@link com.sun.xml.bind.v2.model.core.PropertyInfo}.
 */
interface PropertySeed<T,C,F,M> extends Locatable, AnnotationSource {
     ...
     *
     * @see com.sun.xml.bind.v2.model.core.PropertyInfo#getName()
     */
    String getName();
     ...
     *
     * <p>
     * The difference between the {@link com.sun.xml.bind.v2.model.runtime.RuntimePropertyInfo#getIndividualType()}
     * and this method is clear when the property is a multi-value property.
     * The {@link com.sun.xml.bind.v2.model.runtime.RuntimePropertyInfo#getIndividualType()} method returns the type of the item,
