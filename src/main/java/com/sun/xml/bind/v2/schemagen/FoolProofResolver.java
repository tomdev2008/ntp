...
/**
 * {@link javax.xml.bind.SchemaOutputResolver} that wraps the user-specified resolver
 * and makes sure that it's following the contract.
 *
 * <p>
 * This protects the rest of the {@link com.sun.xml.bind.v2.schemagen.XmlSchemaGenerator} from client programming
 * error.
 */
