...
/**
 * Implementation of {@link javax.xml.bind.Marshaller} interface for the JAXB RI.
 *
 * <p>
...
public /*to make unit tests happy*/ final class MarshallerImpl extends AbstractMarshallerImpl implements ValidationEventHandler
{
    ...
    /**
     * @param assoc
     *      non-null if the marshaller is working inside {@link com.sun.xml.bind.v2.runtime.BinderImpl}.
     */
    ...
    /**
     * Marshals to {@link java.io.OutputStream} with the given in-scope namespaces
     * taken into account.
     *
     * @since 2.1.5
     */
    ...
    /**
     * Creates {@link com.sun.xml.bind.v2.runtime.output.XmlOutput} from the given {@link javax.xml.transform.Result} object.
     */
    ...
    /**
     * Used by {@link com.sun.xml.bind.v2.runtime.BridgeImpl} to write an arbitrary object as a fragment.
     */
...
;
    ...
    /**
     * Default error handling behavior fot {@link javax.xml.bind.Marshaller}.
     */
