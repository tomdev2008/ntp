...
/**
 * {@link javax.xml.bind.annotation.adapters.XmlAdapter} that binds the value as a SOAP attachment.
 *
 * <p>
 * On the user classes the SwA handling is done by using the {@link javax.xml.bind.annotation.XmlAttachmentRef}
 * annotation, but internally we treat it as a {@link javax.xml.bind.annotation.adapters.XmlJavaTypeAdapter} with this
