 ...
 *
 * <p>
 * {@link com.sun.xml.bind.v2.runtime.Transducer}s are immutable.
 *
...
public interface Transducer<ValueT> {
    ...
    /**
     * If this {@link com.sun.xml.bind.v2.runtime.Transducer} is the default transducer for the <code>ValueT</code>,
     * this method returns true.
     *
     * Used exclusively by {@link com.sun.xml.bind.v2.runtime.reflect.opt.OptimizedTransducedAccessorFactory#get(com.sun.xml.bind.v2.model.runtime.RuntimePropertyInfo)}
     */
    boolean isDefault();

    /**
     * If true, this {@link com.sun.xml.bind.v2.runtime.Transducer} doesn't declare any namespace,
     * and therefore {@link #declareNamespace(Object, com.sun.xml.bind.v2.runtime.XMLSerializer)} is no-op.
     *
     ...
     * to one of the {@link com.sun.xml.bind.v2.runtime.XMLSerializer#text(String, String)} method,
    ...
    /**
     * Sends the result of the {@link #print(Object)} operation
     * to one of the {@link com.sun.xml.bind.v2.runtime.XMLSerializer#leafElement(com.sun.xml.bind.v2.runtime.Name, String, String)} method.
     * but with the best representation of the value, not necessarily String.
     */
     ...
     * but sometimes (most notably {@link javax.xml.datatype.XMLGregorianCalendar},
