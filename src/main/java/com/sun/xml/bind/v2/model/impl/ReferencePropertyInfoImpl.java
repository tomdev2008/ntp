...
/**
 * Implementation of {@link com.sun.xml.bind.v2.model.core.ReferencePropertyInfo}.
 *
    ...
    implements ReferencePropertyInfo<T,C>, DummyPropertyInfo<T, C, F, M>
{
     ...
     *
     * @param last
     *      if true, every {@link javax.xml.bind.annotation.XmlElementRef} must yield at least one type.
     */
     ...
     * we don't waste time generating exceptions every time we call {@link #isRequired(javax.xml.bind.annotation.XmlElementRef)}.
     */
