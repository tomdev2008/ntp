...
/**
 * {@link java.util.Stack}-like data structure that allows the following efficient operations:
 *
 * <ol>
 ...
 *
 * <p>
 * This class implements {@link java.util.List} for accessing items in the stack,
 * but {@link java.util.List} methods that alter the stack is not supported.
 *
