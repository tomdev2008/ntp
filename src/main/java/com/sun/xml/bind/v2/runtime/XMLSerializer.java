...
/**
 * Receives XML serialization event and writes to {@link com.sun.xml.bind.v2.runtime.output.XmlOutput}.
 * 
 * <p>
 ...
 * <p>
 * {@link java.io.IOException}, {@link org.xml.sax.SAXException}, and {@link javax.xml.stream.XMLStreamException}
 * are thrown from {@link com.sun.xml.bind.v2.runtime.output.XmlOutput}. They are always considered fatal, and
 * therefore caught only by {@link com.sun.xml.bind.v2.runtime.MarshallerImpl}.
 * <p>
 * {@link com.sun.xml.bind.api.AccessorException} can be thrown when an access to a property/field
...
public final class XMLSerializer extends Coordinator {
    ...
    /**
     * Cached instance of {@link com.sun.xml.bind.v2.runtime.unmarshaller.Base64Data}.
     */
    private Base64Data base64Data;

    /**
     * Cached instance of {@link com.sun.xml.bind.v2.runtime.unmarshaller.IntData}.
     */
    ...
    /**
     * Gets the cached instance of {@link com.sun.xml.bind.v2.runtime.unmarshaller.Base64Data}.
     *
     * @deprecated
     *      {@link com.sun.xml.bind.v2.runtime.unmarshaller.Base64Data} is no longer cached, so that
...
//    void leafElement( QName tagName, boolean value, String fieldName ) throws SAXException;
    ...
    /**
     * The {@link #text(String, String)} method that takes {@link com.sun.xml.bind.v2.runtime.output.Pcdata}.
     */
     ...
     *
     * @param child
     *      Object to be marshalled. The {@link com.sun.xml.bind.v2.runtime.JaxBeanInfo} for
     ...
     *
     * <p>
     * This method shall be used from those {@link com.sun.xml.bind.v2.model.runtime.RuntimeBuiltinLeafInfo} that are
    ...
    /**
     * This method is used by {@link com.sun.xml.bind.v2.runtime.MimeTypedTransducer} to set the expected MIME type
     * for the encapsulated {@link com.sun.xml.bind.v2.runtime.Transducer}.
     */
    ...
    /**
     * Field used to support an {@link javax.xml.bind.annotation.XmlSchemaType} annotation.
     *
     * <p>
     * When we are marshalling a property with an effective {@link javax.xml.bind.annotation.XmlSchemaType},
     * this field is set to hold the QName of that type. The {@link com.sun.xml.bind.v2.runtime.Transducer} that
     ...
     * returns the current {@link com.sun.xml.bind.v2.runtime.XMLSerializer} in charge.
     */
