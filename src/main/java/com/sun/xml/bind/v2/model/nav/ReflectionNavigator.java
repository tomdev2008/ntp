...
/**
 * {@link com.sun.xml.bind.v2.model.nav.Navigator} implementation for {@code java.lang.reflect}.
 *
 */
public final class ReflectionNavigator implements Navigator<Type,Class,Field,Method> {
     ...
     * Singleton.
     *
     * Use {@link com.sun.xml.bind.v2.model.nav.Navigator#REFLECTION}
     */
    ReflectionNavigator() {}
    ...
    private static final TypeVisitor<Type,Class> baseClassFinder = new TypeVisitor<Type,Class>() {
         ...
         *
         * @param decl
         *      provides a list of type variables. See {@link java.lang.reflect.GenericDeclaration#getTypeParameters()}
         * @param args
         *      actual arguments. See {@link java.lang.reflect.ParameterizedType#getActualTypeArguments()}
         */
    ...
    /**
     * Implements the logic for {@link #erasure(java.lang.reflect.Type)}.
     */
     ...
     * on {@link com.sun.xml.bind.v2.model.nav.Navigator}.
     *
     * <p>
    ...
    /**
     * Returns the {@link java.lang.reflect.Type} object that represents {@code clazz&lt;T1,T2,T3>}.
     */
    ...
    /**
     * JDK 5.0 has a bug of createing {@link java.lang.reflect.GenericArrayType} where it shouldn't.
