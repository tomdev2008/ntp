...
public class IllegalAnnotationException extends JAXBException {
    ...
    /**
     * Read-only list of {@link com.sun.xml.bind.v2.runtime.Location}s.
     */
    ...
    /**
     * Builds a list of {@link com.sun.xml.bind.v2.runtime.Location}s out of a {@link com.sun.xml.bind.v2.model.annotation.Locatable}.
     */
    ...
    /**
     * Returns a read-only list of {@link com.sun.xml.bind.v2.runtime.Location} that indicates
     ...
     *
     *
     * <h3>List of {@link com.sun.xml.bind.v2.runtime.Location}</h3>
     * <p>
     * Each error location is identified not just by one {@link com.sun.xml.bind.v2.runtime.Location}
     * object, but by a sequence of {@link com.sun.xml.bind.v2.runtime.Location}s that shows why
     * the runtime is led to the place of the error.
     * This list is sorted such that the most specific {@link com.sun.xml.bind.v2.runtime.Location} comes
     * to the first in the list, sort of like a stack trace.
     *
     * <p>
     * For example, suppose you specify class <tt>Foo</tt> to {@link javax.xml.bind.JAXBContext},
     ...
     * Then when this exception is thrown, the list of {@link com.sun.xml.bind.v2.runtime.Location}s
     ...
     *      null nor length-0 {@link java.util.List}.
     */
