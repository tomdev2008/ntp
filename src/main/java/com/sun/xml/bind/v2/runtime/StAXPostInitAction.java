...
/**
 * Post-init action for {@link com.sun.xml.bind.v2.runtime.MarshallerImpl} that incorporate the in-scope namespace bindings
 * from a StAX writer.
 *
 * <p>
 * It's always used either with {@link javax.xml.stream.XMLStreamWriter}, {@link javax.xml.stream.XMLEventWriter}, or bare
 * {@link javax.xml.namespace.NamespaceContext},
