...
/**
 * Root of models.&nbsp;Set of {@link com.sun.xml.bind.v2.model.core.TypeInfo}s.
 *
...
public interface TypeInfoSet<T,C,F,M> {
    ...
    /**
     * {@link com.sun.xml.bind.v2.model.nav.Navigator} for this model.
     */
...
//    AnnotationReader<T,C,F,M> getReader();
    ...
    /**
     * Returns a {@link com.sun.xml.bind.v2.model.core.TypeInfo} for the given type.
     *
     * @return
    ...
    /**
     * Gets the {@link com.sun.xml.bind.v2.model.core.TypeInfo} for the any type.
     */
    NonElement<T,C> getAnyTypeInfo();

    /**
     * Returns a {@link com.sun.xml.bind.v2.model.core.ClassInfo}, {@link com.sun.xml.bind.v2.model.core.ArrayInfo}, or {@link com.sun.xml.bind.v2.model.core.LeafInfo}
     * for the given bean.
     *
     * <p>
    ...
    /**
     * Returns all the {@link com.sun.xml.bind.v2.model.core.ArrayInfo}s known to this set.
     */
    Map<? extends T,? extends ArrayInfo<T,C>> arrays();

    /**
     * Returns all the {@link com.sun.xml.bind.v2.model.core.ClassInfo}s known to this set.
     */
    Map<C,? extends ClassInfo<T,C>> beans();

    /**
     * Returns all the {@link com.sun.xml.bind.v2.model.core.BuiltinLeafInfo}s known to this set.
     */
    Map<T,? extends BuiltinLeafInfo<T,C>> builtins();

    /**
     * Returns all the {@link com.sun.xml.bind.v2.model.core.EnumLeafInfo}s known to this set.
     */
    Map<C,? extends EnumLeafInfo<T,C>> enums();

    /**
     * Returns a {@link com.sun.xml.bind.v2.model.core.ElementInfo} for the given element.
     *
     * @param scope
    ...
    /**
     * Returns all  {@link com.sun.xml.bind.v2.model.core.ElementInfo}s in the given scope.
     *
     * @param scope
    ...
    /**
     * Returns all the {@link com.sun.xml.bind.v2.model.core.ElementInfo} known to this set.
     */
    Iterable<? extends ElementInfo<T,C>> getAllElements();


    /**
     * Gets all {@link javax.xml.bind.annotation.XmlSchema#xmlns()} found in this context for the given namespace URI.
     *
     * <p>
    ...
    /**
     * Gets {@link javax.xml.bind.annotation.XmlSchema#location()} found in this context.
     *
     * <p>
     * This operation is expected to be only used in schema generator, so it can be slow.
     *
    ...
    /**
     * Gets the reasonable {@link javax.xml.bind.annotation.XmlNsForm} for the given namespace URI.
     *
     * <p>
     * The spec doesn't define very precisely what the {@link javax.xml.bind.annotation.XmlNsForm} value
