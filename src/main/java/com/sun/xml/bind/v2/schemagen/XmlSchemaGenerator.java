 ...
 * <ol>
 *  <li>Create a new {@link com.sun.xml.bind.v2.schemagen.XmlSchemaGenerator}
 *  <li>Invoke {@link #add} methods, multiple times if necessary.
 *  <li>Invoke {@link #write}
 *  <li>Discard the {@link com.sun.xml.bind.v2.schemagen.XmlSchemaGenerator}.
 * </ol>
 *
...
public final class XmlSchemaGenerator<T,C,F,M> {
     ...
     *
     * <p>
     * We use a {@link java.util.TreeMap} here so that the suggested names will
     * be consistent across JVMs.
     *
     * @see javax.xml.bind.SchemaOutputResolver#createOutput(String, String)
     */
    private final Map<String,Namespace> namespaces = new TreeMap<String,Namespace>(NAMESPACE_COMPARATOR);

    /**
     * {@link com.sun.xml.bind.api.ErrorListener} to send errors to.
     */
     ...
     *
     * <p>
     * A {@link com.sun.xml.bind.v2.model.core.ClassInfo} may have two namespaces --- one for the element name
     * and the other for the type name. If they are different, we put the same
     * {@link com.sun.xml.bind.v2.model.core.ClassInfo} to two {@link com.sun.xml.bind.v2.schemagen.XmlSchemaGenerator.Namespace}s.
     */
    ...
    private class Namespace {
        ...
        /**
         * Other {@link com.sun.xml.bind.v2.schemagen.XmlSchemaGenerator.Namespace}s that this namespace depends on.
         */
        ...
        abstract class ElementDeclaration {
            /**
             * Returns true if two {@link com.sun.xml.bind.v2.schemagen.XmlSchemaGenerator.Namespace.ElementDeclaration}s are representing
        ...
        /**
         * {@link com.sun.xml.bind.v2.schemagen.XmlSchemaGenerator.Namespace.ElementDeclaration} that refers to a {@link com.sun.xml.bind.v2.model.core.NonElement}.
         */
    ...
    /**
     * Debug information of what's in this {@link com.sun.xml.bind.v2.schemagen.XmlSchemaGenerator}.
     */
    public String toString() {
        StringBuilder buf = new StringBuilder();
