 ...
 *
 * The {@link com.sun.xml.bind.v2.runtime.unmarshaller.XmlVisitor} expects the event callbacks in the following order:
 * <pre>
 ...
 * For example, see {@link com.sun.xml.bind.v2.runtime.unmarshaller.Base64Data}.
 *
 * <h2>Error Handling</h2>
 * The visitor may throw {@link org.xml.sax.SAXException} to abort the unmarshalling process
 * in the middle.
 *
...
public interface XmlVisitor {
     ...
     *      pass in additional {@link javax.xml.namespace.NamespaceContext} object that knows about the
     ...
     *
     * <p>
     * The caller should consult {@link com.sun.xml.bind.v2.runtime.unmarshaller.XmlVisitor.TextPredictor} to see
    ...
    /**
     * Returns the {@link com.sun.xml.bind.v2.runtime.unmarshaller.UnmarshallingContext} at the end of the chain.
     *
     * @return
    ...
    interface TextPredictor {
         ...
         * and thus need to be reported as a {@link com.sun.xml.bind.v2.runtime.unmarshaller.XmlVisitor#text} event. Furthermore,
         * if the element has no children (like &lt;foo/>), then it has to be reported
         * an empty {@link com.sun.xml.bind.v2.runtime.unmarshaller.XmlVisitor#text} event.
         */
        boolean expectText();
    }
}
