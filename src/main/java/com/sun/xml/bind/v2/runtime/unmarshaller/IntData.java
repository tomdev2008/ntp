...
/**
 * {@link com.sun.xml.bind.v2.runtime.output.Pcdata} that represents a single integer.
 *
 * @author Kohsuke Kawaguchi
 */
public class IntData extends Pcdata {
    /**
     * The int value that this {@link com.sun.xml.bind.v2.runtime.output.Pcdata} represents.
     *
     * Modifiable.
     */
    private int data;
