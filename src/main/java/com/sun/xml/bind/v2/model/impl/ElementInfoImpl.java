...
/**
 * {@link com.sun.xml.bind.v2.model.core.ElementInfo} implementation.
 *
...
class ElementInfoImpl<T,C,F,M> extends TypeInfoImpl<T,C,F,M> implements ElementInfo<T,C> {
    ...
    /**
     * Lazily constructed list of {@link com.sun.xml.bind.v2.model.core.ElementInfo}s that can substitute this element.
     * This could be null.
     * @see #link()
     */
    ...
    /**
     * Singleton instance of {@link com.sun.xml.bind.v2.model.core.ElementPropertyInfo} for this element.
     */
    protected class PropertyImpl implements
        ...
        /**
         * For {@link com.sun.xml.bind.v2.model.core.ElementInfo}s, a collection always means a list of values.
         */
    ...
    /**
     * @param m
     *      The factory method on ObjectFactory that comes with {@link javax.xml.bind.annotation.XmlElementDecl}.
     */
