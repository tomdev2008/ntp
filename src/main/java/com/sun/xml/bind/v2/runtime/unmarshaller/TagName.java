 ...
 * {@link com.sun.xml.bind.v2.runtime.unmarshaller.XmlVisitor}. Note that the rest of the unmarshaller may
 * modify any of the fields while processing an event (such as to
 * intern strings, replace attributes),
 * so {@link com.sun.xml.bind.v2.runtime.unmarshaller.XmlVisitor} should reset all fields for each use.
 *
 * <p>
...
public abstract class TagName {
     ...
     *
     * This might be {@link com.sun.xml.bind.v2.runtime.unmarshaller.AttributesEx}.
     */
...
//    }
    ...
    /**
     * Creates {@link javax.xml.namespace.QName}.
     */
