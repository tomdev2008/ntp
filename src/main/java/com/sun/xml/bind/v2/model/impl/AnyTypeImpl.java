...
/**
 * {@link com.sun.xml.bind.v2.model.core.TypeInfo} implementation for <tt>xs:anyType</tt>.
 *
...
class AnyTypeImpl<T,C> implements NonElement<T,C> {
    ...
    /**
     * xs:anyType can be referenced from {@link javax.xml.bind.annotation.XmlIDREF}.
     *
     * @deprecated
