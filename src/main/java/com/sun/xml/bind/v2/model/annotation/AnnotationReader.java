 ...
 *
 * <p>
 * Because the former operates on a {@link java.lang.reflect.Field} and {@link java.lang.reflect.Method}
 ...
 *
 * <p>
 * Most of the get method takes {@link com.sun.xml.bind.v2.model.annotation.Locatable}, which points to
 * the place/context in which the annotation is read. The returned
 * annotation also implements {@link com.sun.xml.bind.v2.model.annotation.Locatable} (so that it can
 * point to the place where the annotation is placed), and its
 * {@link com.sun.xml.bind.v2.model.annotation.Locatable#getUpstream()} will return the given
 * {@link com.sun.xml.bind.v2.model.annotation.Locatable}.
 *
 *
 * <p>
 * Errors found during reading annotations are reported through the error handler.
 * A valid {@link com.sun.xml.bind.v2.model.core.ErrorHandler} must be registered before the {@link com.sun.xml.bind.v2.model.annotation.AnnotationReader}
 * is used.
 *
...
public interface AnnotationReader<T,C,F,M> {
    ...
    /**
     * Similar to {@link #getClassValue(java.lang.annotation.Annotation, String)} method but
