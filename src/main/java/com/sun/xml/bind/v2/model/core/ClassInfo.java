...
public interface ClassInfo<T,C> extends MaybeElement<T,C> {
     ...
     *
     * <p>
     * Properties marked with {@link javax.xml.bind.annotation.XmlTransient} will not show up
    ...
    /**
     * Returns true if this class or its ancestor has {@link javax.xml.bind.annotation.XmlValue}
     * property.
     */
    ...
    /**
     * True if there's a known sub-type of this class in {@link com.sun.xml.bind.v2.model.core.TypeInfoSet}.
     */
