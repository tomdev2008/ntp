...
/**
 * A list of {@link com.sun.xml.bind.v2.runtime.IllegalAnnotationException} wrapped in one exception.
 *
 * <p>
 * This exception is used to report all the errors to the client application
 * through {@link javax.xml.bind.JAXBContext#newInstance}.
 *
 * @since JAXB 2.0 EA1
...
public class IllegalAnnotationsException extends JAXBException {
    ...
    /**
     * Returns a read-only list of {@link com.sun.xml.bind.v2.runtime.IllegalAnnotationException}s
