...
/**
 * Object that returns the current location that the {@link com.sun.xml.bind.v2.runtime.unmarshaller.XmlVisitor} is parsing.
 *
 * @author Kohsuke Kawaguchi
 */
public interface LocatorEx extends Locator {
    /**
     * Gets the current location in a {@link javax.xml.bind.ValidationEventLocator} object.
     */
    ValidationEventLocator getLocation();

    /**
     * Immutable snapshot of a {@link com.sun.xml.bind.v2.runtime.unmarshaller.LocatorEx}
     */
