...
public abstract class OptimizedAccessorFactory {
    ...
    /**
     * Gets the optimized {@link com.sun.xml.bind.v2.runtime.reflect.Accessor} that accesses the given getter/setter.
     *
     * @return null
    ...
    /**
     * Gets the optimizd {@link com.sun.xml.bind.v2.runtime.reflect.Accessor} that accesses the given field.
     *
     * @return null
     *      if for some reason it fails to create an optimized version.
     */
