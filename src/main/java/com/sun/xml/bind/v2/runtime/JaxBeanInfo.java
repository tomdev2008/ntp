 ...
 * 
 * <p>
 * Each JAXB-bound class has a corresponding {@link com.sun.xml.bind.v2.runtime.JaxBeanInfo} object,
 * which performs all the JAXB related operations on behalf of
 * the JAXB-bound object.
 * 
 * <p>
 * Given a class, the corresponding {@link com.sun.xml.bind.v2.runtime.JaxBeanInfo} can be located
 * via {@link com.sun.xml.bind.v2.runtime.JAXBContextImpl#getBeanInfo(Class,boolean)}.
 * 
 * <p>
 * Typically, {@link com.sun.xml.bind.v2.runtime.JaxBeanInfo} implementations should be generated
...
public abstract class JaxBeanInfo<BeanT> {
    ...
    /**
     * For {@link com.sun.xml.bind.v2.runtime.JaxBeanInfo} that has multiple type names.
     */
    ...
    /**
     * For {@link com.sun.xml.bind.v2.runtime.JaxBeanInfo} that has one type name.
     */
    ...
    /**
     * For {@link com.sun.xml.bind.v2.runtime.JaxBeanInfo} that has no type names.
     */
    ...
    /**
     * Gets the JAXB bound class type that this {@link com.sun.xml.bind.v2.runtime.JaxBeanInfo}
     * handles.
     * 
     * <p>
    ...
    /**
     * Type names associated with this {@link com.sun.xml.bind.v2.runtime.JaxBeanInfo}.
     *
     * @see #getTypeNames()
     */
     ...
     * instance, but there's a few exceptions (most notably {@link javax.xml.datatype.XMLGregorianCalendar}),
     ...
     *      as a result of reporting an error, the context may throw a {@link org.xml.sax.SAXException}.
     */
     ...
     *
     * <p>
     * For schema-to-java, this is equivalent to {@link #serializeBody(Object, com.sun.xml.bind.v2.runtime.XMLSerializer)}.
     */
    ...
    /**
     * Gets the {@link com.sun.xml.bind.v2.runtime.unmarshaller.Loader} that will unmarshall the given object.
     *
     * @param context
     *      The {@link com.sun.xml.bind.v2.runtime.JAXBContextImpl} object that governs this object.
     *      This object is taken as a parameter so that {@link com.sun.xml.bind.v2.runtime.JaxBeanInfo} doesn't have
     ...
     *      If true, the returned {@link com.sun.xml.bind.v2.runtime.unmarshaller.Loader} is capable of recognizing @xsi:type (if necessary)
     *      and unmarshals a subtype. This allowes an optimization where this bean info
     *      is guaranteed not to have a type substitution.
     *      If false, the returned {@link com.sun.xml.bind.v2.runtime.unmarshaller.Loader} doesn't look for @xsi:type.
     * @return
     ...
     * this method return a {@link com.sun.xml.bind.v2.runtime.Transducer} that lets you convert
    ...
    /**
     * Called after all the {@link com.sun.xml.bind.v2.runtime.JaxBeanInfo}s are created.
     * @param grammar
     */
    ...
    /**
     * Called at the end of the {@link javax.xml.bind.JAXBContext} initialization phase
