 ...
 * {@link com.sun.xml.bind.v2.runtime.unmarshaller.UnmarshallingContext} and {@link com.sun.xml.bind.v2.runtime.XMLSerializer} instances
 ...
 * (Note that the same {@link com.sun.xml.bind.v2.runtime.Coordinator} can be then used by a different thread
 * for an entirely different episode.)
 *
 * This class also maintains the user-configured instances of {@link javax.xml.bind.annotation.adapters.XmlAdapter}s.
 *
 * <p>
 * This class implements {@link org.xml.sax.ErrorHandler} and propages erros to this object
 * as the {@link javax.xml.bind.ValidationEventHandler}, which will be implemented in a derived class.
 *
...
public abstract class Coordinator implements ErrorHandler, ValidationEventHandler {
    ...
    /**
     * The {@link com.sun.xml.bind.v2.runtime.Coordinator} in charge before this {@link com.sun.xml.bind.v2.runtime.Coordinator}.
     */
    private Object old;

    /**
     * A 'pointer' to a {@link com.sun.xml.bind.v2.runtime.Coordinator} that keeps track of the currently active {@link com.sun.xml.bind.v2.runtime.Coordinator}.
    ...
    /**
     * Associates this {@link com.sun.xml.bind.v2.runtime.Coordinator} with the current thread.
    ...
    /**
     * Dis-associate this {@link com.sun.xml.bind.v2.runtime.Coordinator} with the current thread.
    ...
    /**
     * Called whenever an execution flow enters the realm of this {@link com.sun.xml.bind.v2.runtime.Coordinator}.
     */
    ...
    /**
     * Called whenever an execution flow exits the realm of this {@link com.sun.xml.bind.v2.runtime.Coordinator}.
     */
