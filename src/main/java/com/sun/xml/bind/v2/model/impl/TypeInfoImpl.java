...
/**
 * Common implementation between {@link com.sun.xml.bind.v2.model.impl.ClassInfoImpl} and {@link com.sun.xml.bind.v2.model.impl.ElementInfoImpl}.
 *
...
abstract class TypeInfoImpl<TypeT,ClassDeclT,FieldT,MethodT>
    ...
    /**
     * {@link com.sun.xml.bind.v2.model.core.TypeInfoSet} to which this class belongs.
     */
    protected final TypeInfoSetImpl<TypeT,ClassDeclT,FieldT,MethodT> owner;

    /**
     * Reference to the {@link com.sun.xml.bind.v2.model.impl.ModelBuilder}, only until we link {@link com.sun.xml.bind.v2.model.core.TypeInfo}s all together,
     * because we don't want to keep {@link com.sun.xml.bind.v2.model.impl.ModelBuilder} too long.
     */
    ...
    /**
     * Parses an {@link javax.xml.bind.annotation.XmlRootElement} annotation on a class
    ...
    /**
     * Parses a (potentially-null) {@link javax.xml.bind.annotation.XmlType} annotation on a class
     * and determine the actual value.
     *
     * @param clazz
     *      The class on which the XmlType annotation is checked.
     * @param t
     *      The {@link javax.xml.bind.annotation.XmlType} annotation on the clazz. This value
