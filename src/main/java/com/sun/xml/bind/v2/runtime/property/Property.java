...
//    RuntimePropertyInfo owner();
    ...
    /**
     * @see com.sun.xml.bind.v2.runtime.JaxBeanInfo#serializeBody(Object, com.sun.xml.bind.v2.runtime.XMLSerializer)
     *
     * @param outerPeer
     ...
     *      this is only used for {@link com.sun.xml.bind.v2.runtime.JaxBeanInfo} for {@link javax.xml.bind.JAXBElement}s.
    ...
    /**
     * @see com.sun.xml.bind.v2.runtime.JaxBeanInfo#serializeURIs(Object, com.sun.xml.bind.v2.runtime.XMLSerializer)
     */
    public void serializeURIs(BeanT beanT, XMLSerializer target) throws SAXException, AccessorException;

    /**
     * Returns true if
     * {@link #serializeURIs(Object, com.sun.xml.bind.v2.runtime.XMLSerializer)} performs some meaningful action.
     */
...
//    Unmarshaller.Handler createUnmarshallerHandler(JAXBContextImpl grammar, Unmarshaller.Handler tail);
     ...
     *
     * This method is only used when the corresponding {@link com.sun.xml.bind.v2.model.core.PropertyInfo#id()} is {@link com.sun.xml.bind.v2.model.core.ID#ID},
    ...
    /**
     * Provides more {@link com.sun.xml.bind.v2.model.runtime.RuntimePropertyInfo} information on the property.
     *
     * @return
     *      null if RETAIN_REFERENCE_TO_INFO property is not set on the {@link javax.xml.bind.JAXBContext}
     */
