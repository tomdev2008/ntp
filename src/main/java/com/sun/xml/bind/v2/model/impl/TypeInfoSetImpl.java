...
/**
 * Set of {@link com.sun.xml.bind.v2.model.core.TypeInfo}s.
 *
 * <p>
 * This contains a fixed set of {@link com.sun.xml.bind.v2.model.core.LeafInfo}s and arbitrary set of {@link com.sun.xml.bind.v2.model.core.ClassInfo}s.
 *
 * <p>
...
class TypeInfoSetImpl<T,C,F,M> implements TypeInfoSet<T,C,F,M> {
    ...
    /** All {@link com.sun.xml.bind.v2.model.impl.EnumLeafInfoImpl}s. */
    private final Map<C,EnumLeafInfoImpl<T,C,F,M>> enums =
            new LinkedHashMap<C,EnumLeafInfoImpl<T,C,F,M>>();

    /** All {@link com.sun.xml.bind.v2.model.impl.ArrayInfoImpl}s. */
     ...
     *
     * Using {@link java.util.LinkedHashMap} allows us to process classes
    ...
    /**
     * {@link com.sun.xml.bind.v2.model.core.TypeInfo} for <tt>xs:anyType</tt>.
     *
     * anyType is the only {@link com.sun.xml.bind.v2.model.core.TypeInfo} that works with an interface,
     * and accordingly it requires a lot of special casing.
     */
    private final NonElement<T,C> anyType;

    /**
     * Lazily parsed set of {@link javax.xml.bind.annotation.XmlNs}s.
     *
     * @see #getXmlNs(String)
     */
    ...
    /**
     * Adds a new {@link com.sun.xml.bind.v2.model.core.ClassInfo} to the set.
     */
    ...
    /**
     * Adds a new {@link com.sun.xml.bind.v2.model.core.LeafInfo} to the set.
     */
    ...
    /**
     * Returns a {@link com.sun.xml.bind.v2.model.core.ClassInfo} for the given bean.
     *
     * <p>
