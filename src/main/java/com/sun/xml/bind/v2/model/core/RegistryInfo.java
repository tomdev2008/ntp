...
/**
 * Represents the information in a class with {@link javax.xml.bind.annotation.XmlRegistry} annotaion.
 *
 * <p>
...
public interface RegistryInfo<T,C> {
    ...
    /**
     * Returns the class with {@link javax.xml.bind.annotation.XmlRegistry}.
     */
    C getClazz();
}
