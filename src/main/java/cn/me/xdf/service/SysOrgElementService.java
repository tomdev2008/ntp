...
public class SysOrgElementService extends BaseService {
	...
	public List<SysOrgElement> findTypeis1(){
		Finder finder = Finder
				.create("from SysOrgElement e where (e.hbmParent.fdId = :fdId or e.fdNo= :fdNo)");
		finder.setParam("fdId", "13ca02c2af70a0072c65c3644b28f42d");
		finder.setParam("fdNo", "105");
		return find(finder);
	}
	
	public List<SysOrgElement> findElement(String fdId){
