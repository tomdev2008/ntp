...
<script id="examQuestionTemplate" type="text/x-dot-template">
	    <tr data-fdid="{{=it.id}}" >
		    ...
		    <td><input id="sore_{{=it.id}}" type="text" digits="true" max="100" min="0" onblur="initScore()"  style="width:30px" value="{{=it.score}}" data-toggle="tooltip" title="输入数字做为整数且不能大于20分" class="itemScore input-mini digits">分
